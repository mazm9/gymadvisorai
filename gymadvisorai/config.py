...
# load .env from project root (parent of package dir)
...
class Settings:
    ...
    openai_model: str = require_env("OPENAI_MODEL")          # deployment name
    openai_endpoint: str = require_env("OPENAI_ENDPOINT")    # https://...azure.com
